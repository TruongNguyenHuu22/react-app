...
export default function TableHeader() {
  ...
  console.log('🚀 ~ file: TableHeader.jsx:229 ~ TableHeader ~ cartItems:', cartItems);
          ...
          <TableBody>
            {cartItems.map((row) => (
              <TableRow hover role="checkbox" tabIndex={-1}>
                ...
                <TableCell align="right">{row.product.salePrice}</TableCell>
                <TableCell align="right">{row.quantity}</TableCell>
                <TableCell align="right">{row.product.salePrice * row.quantity}</TableCell>
